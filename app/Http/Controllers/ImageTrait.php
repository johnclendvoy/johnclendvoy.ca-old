...
trait ImageTrait {
    ...
    */
    private function saveAllImages($img, $objectname, $prefix = NULL)
    {
        ...
        {
            if( isset($size['fit']))
                 $this->makeResizedImage($objectname, $size['name'], $filename, $size['width'], $size['height'], $size['fit']);
            else
            {
    ...
    */
    public static function saveImage($file, $objectname, $dirname, $prefix = NULL)
    {
        ...
        $file->move($fullImagePath, $filename);

        $img = Image::make($fullImagePath . '/' . $filename);
    ...
    */
    public static function makeResizedImage($objectname, $dirname, $filename, $width, $height, $fit = null)
    {
